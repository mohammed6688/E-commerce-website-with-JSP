    ...
    <table class="table table-condensed">
        ...
        <tr>
            ...
            <td class="cart_delete">
                <a class="cart_quantity_delete" href="addProduct.jsp?mode=edit&id=<%=i.getId()%>"><i class="fa fa-times"></i></a>
            </td>
<%--            <td class="cart_delete">--%>
<%--                <a class="cart_quantity_delete" href="admin.jsp?mode=delete&id=<%=i.getId()%>"><i class="fa fa-times"></i></a>--%>
<%--            </td>--%>
        </tr>
