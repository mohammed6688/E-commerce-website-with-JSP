...
public class SiteParser {
    ...
    public List<Cart> getCart() throws JsonProcessingException {
    ...
    public List<Product> getProduct(int id) throws JsonProcessingException {
    ...
    public List<Product> getProduct(String title) throws JsonProcessingException {
    ...
    public void addToCart(Cart cart) throws JsonProcessingException {
    ...
    public void deleteFromCart(int productid, int userid) throws JsonProcessingException {
    ...
    public int AddProduct(String title, int Price, int Quantity, String photoUrl, String details, String category) throws JsonProcessingException {
    ...
    public String checkSignUp(boolean admin, String name, Date birthday, String password, int phonenumber, String job, String email, int creditlimit, String address, String interests) throws JsonProcessingException {
    ...
    public User checkSignIn(String email, String password) throws JsonProcessingException {
    ...
    public int editProduct(int price, int quantity, int id) throws JsonProcessingException {
    ...
    public String checkout(User user) throws JsonProcessingException {
